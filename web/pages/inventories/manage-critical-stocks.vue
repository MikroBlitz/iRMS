...
const modelHeaders: Headers[] = [
    ...
    { key: 'product.name', label: 'Product' },
    {
        key: (val) => {
            ...
            return `<span
                        class="inline-block px-2 py-0.5 rounded-full text-xs bg-red-50 text-red-700 border border-red-700 animate-pulse dark:bg-red-900 dark:text-white dark:border-red-400"
                    >
