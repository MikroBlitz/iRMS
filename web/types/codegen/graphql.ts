...
export type Product = {
  ...
  name: Scalars['String']['output'];
  order_items?: Maybe<Array<Maybe<OrderItem>>>;
  po_unit?: Maybe<Scalars['String']['output']>;
  price?: Maybe<Scalars['Float']['output']>;
...
export type ProductInput = {
  ...
  po_unit?: InputMaybe<Scalars['String']['input']>;
  price?: InputMaybe<Scalars['Float']['input']>;
...
export type Query = {
  ...
  overallSales?: Maybe<Scalars['Float']['output']>;
  ...
  weeklySales?: Maybe<Scalars['Float']['output']>;
};
...
export type QueryLowStocksInventoriesArgs = {
...
export type ChartsDataQuery = { __typename?: 'Query', usersCount: number, messagesCount: number, customersCount: number, categoriesCount: number, productsCount: number, ordersCount: number, products: Array<{ __typename?: 'Product', id: string, name: string, price?: number | null, inventories?: Array<{ __typename?: 'Inventory', qty: number } | null> | null }>, orders: Array<{ __typename?: 'Order', total_amount?: number | null }> };
...
export type ProductFragment = { __typename?: 'Product', id: string, name: string, image?: string | null, category_id?: string | null, description?: string | null, sku: string, po_unit?: string | null, price?: number | null, created_at?: any | null, updated_at?: any | null, deleted_at?: any | null, category?: { __typename?: 'Category', id: string, name: string } | null, inventories?: Array<{ __typename?: 'Inventory', id: string, qty: number, location?: string | null } | null> | null } & { ' $fragmentName'?: 'ProductFragment' };
...
export type LowStocksInventoriesQueryVariables = Exact<{
  value?: InputMaybe<Scalars['Int']['input']>;
}>;


export type LowStocksInventoriesQuery = { __typename?: 'Query', lowStocksInventories: Array<{ __typename?: 'Inventory', id: string, product_id?: string | null, qty: number, location?: string | null, updated_at?: any | null, product?: { __typename?: 'Product', name: string, po_unit?: string | null } | null }> };
...
export type MessagesQuery = { __typename?: 'Query', messages: { __typename?: 'MessagePaginator', data: Array<{ __typename?: 'Message', id: string, sender_id?: number | null, receiver_id?: number | null, message: string, created_at?: any | null }>, paginatorInfo: { __typename?: 'PaginatorInfo', currentPage: number, lastPage: number, perPage: number, total: number } } };
...
export type UpsertMessageMutation = { __typename?: 'Mutation', upsertMessage?: { __typename?: 'Message', id: string, message: string, sender?: { __typename?: 'User', id: string, name?: string | null } | null, receiver?: { __typename?: 'User', id: string, name?: string | null } | null } | null };
...
export type OverallSalesQueryVariables = Exact<{ [key: string]: never; }>;


export type OverallSalesQuery = { __typename?: 'Query', overallSales?: number | null };

export type DailySalesQueryVariables = Exact<{ [key: string]: never; }>;


export type DailySalesQuery = { __typename?: 'Query', dailySales?: number | null };

export type WeeklySalesQueryVariables = Exact<{ [key: string]: never; }>;


export type WeeklySalesQuery = { __typename?: 'Query', weeklySales?: number | null };

export type MonthlySalesQueryVariables = Exact<{ [key: string]: never; }>;


export type MonthlySalesQuery = { __typename?: 'Query', monthlySales?: number | null };
...
export type UserFilterQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, name?: string | null }> };
...
export const LowStocksInventoriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"lowStocksInventories"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"value"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lowStocksInventories"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"value"},"value":{"kind":"Variable","name":{"kind":"Name","value":"value"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"product_id"}},{"kind":"Field","name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"po_unit"}}]}},{"kind":"Field","name":{"kind":"Name","value":"qty"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]}}]} as unknown as DocumentNode<LowStocksInventoriesQuery, LowStocksInventoriesQueryVariables>;
...
export const OverallSalesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"overallSales"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"overallSales"}}]}}]} as unknown as DocumentNode<OverallSalesQuery, OverallSalesQueryVariables>;
export const DailySalesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"dailySales"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dailySales"}}]}}]} as unknown as DocumentNode<DailySalesQuery, DailySalesQueryVariables>;
export const WeeklySalesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"weeklySales"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"weeklySales"}}]}}]} as unknown as DocumentNode<WeeklySalesQuery, WeeklySalesQueryVariables>;
export const MonthlySalesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"monthlySales"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"monthlySales"}}]}}]} as unknown as DocumentNode<MonthlySalesQuery, MonthlySalesQueryVariables>;
